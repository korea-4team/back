...
public class WebSecurityConfig {
  ...
  protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity
      ...
      .authorizeRequests()
      .antMatchers("/", "/auth/**", "/search/**", "/file/**", "/notice-board/**","/admin/**", "/event-board/**","/advertising-board/**").permitAll()
      .antMatchers(HttpMethod.GET, "/review-board/**", "/notice-board/**","/advertising-board/**").permitAll()
