...
@Getter
@AllArgsConstructor
public class DeleteEventBoardResponseDto extends ResponseDto {
    
    private DeleteEventBoardResponseDto(String code, String message) {
        super(code, message);
    }

    public static ResponseEntity<DeleteEventBoardResponseDto> success() {
        DeleteEventBoardResponseDto result = new DeleteEventBoardResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
