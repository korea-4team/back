...
public class GetSearchResponseDto extends ResponseDto {
    ...
    private GetSearchResponseDto(String code, String message, List<ReviewBoardListResponseDto> reviewBoardList, List<AdvertisingListResponseDto> advertisingBoardList) {
        super(code, message);
        this.reviewBoardList = reviewBoardList;
        this.advertisingBoardList = advertisingBoardList;
    }

    public static ResponseEntity<GetSearchResponseDto> success(List<ReviewBoardListResponseDto> reviewBoardList, List<AdvertisingListResponseDto> advertisingBoardList) {
