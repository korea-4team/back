...
public interface ReviewBoardRepository extends JpaRepository<ReviewBoardEntity, Integer> {
    ...
    @Query(value = "SELECT " +
            ...
            "ORDER BY RB.write_datetime DESC ", nativeQuery = true)

    List<ReviewBoardListResultSet> getReviewBoardList(String searchWord);
    ...
    List<ReviewBoardListResultSet> getReviewBoardList(String searchWord, String location);
    ...
    List<ReviewBoardListResultSet> getUserReviewBoardList(String userEmail);
